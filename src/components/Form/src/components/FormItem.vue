...
export default defineComponent({
    ...
    setup(props, { slots }) {
        ...
        const getValues = computed(() => {
            ...
            // @ts-ignore => 类型“{}”上不存在属性“mergeDynamicData”。
        ...
        function getShow(): { isShow: boolean; isIfShow: boolean } {
            ...
            // @ts-ignore => 类型“{}”上不存在属性“showAdvancedButton”。
        ...
        function handleRules(): ValidationRule[] {
            ...
            // @ts-ignore => 类型“{}”上不存在属性“rulesMessageJoinLabel”。
        ...
        function renderComponent() {
            ...
            // @ts-ignore => 类型“{}”上不存在属性“autoSetPlaceHolder”。
            ...
            const compSlot = isFunction(renderComponentContent) ? { ...renderComponentContent(unref(getValues)) } : { default: () => renderComponentContent }
        ...
        return () => {
            ...
            // @ts-ignore => 类型“{}”上不存在属性“baseColProps”。
