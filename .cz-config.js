...
module.exports = {
    ...
    types: [
        ...
        { value: '🚨 remove_warning',          name: '🚨 移除 linter 警告' },
        { value: '🔧 modify_config',           name: '🔧 修改配置文件' },
        { value: '➕ heavy_plus_sign',         name: '➕ 增加一个依赖' },
        { value: '➖ heavy_minus_sign',        name: '➖ 减少一个依赖' },
        { value: '⬆️ arrow_up',                name: '⬆️ 升级依赖' },
        { value: '⬇️ arrow_down',              name: '⬇️ 降级依赖' },
